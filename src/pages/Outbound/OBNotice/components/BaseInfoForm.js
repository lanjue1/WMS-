      ...
      <div className={styles.tableListForm}>
        <Form layout="inline">
          <Row gutter={_gutter}>
            ...
            <Col {..._col}>
              <Form.Item label={'库存锁定'}>
                {getFieldDecorator('lockStatus', {
                  initialValue: selectDetails ? selectDetails.lockStatus : '',
                })(<Input disabled={true} />)}
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={_gutter}>
            <Col {..._col}>
              <Form.Item label={'分配状态'}>
                {getFieldDecorator('allocateStatus', {
                  initialValue: selectDetails ? selectDetails.allocateStatus : '',
                })(<Input disabled={disabled} />)}
              </Form.Item>
            </Col>
            <Col {..._col}>
              <Form.Item label={'挑选状态'}>
                {getFieldDecorator('pickStatus', {
                  initialValue: selectDetails ? selectDetails.pickStatus : '',
                })(<Input disabled={disabled} />)}
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={_gutter}>
            <Col {..._col}>
              <Form.Item label={'复核状态'}>
                {getFieldDecorator('deliveryReviewStatus', {
                  initialValue: selectDetails ? selectDetails.deliveryReviewStatus : '',
                })(<Input disabled={disabled} />)}
              </Form.Item>
            </Col>
            <Col {..._col}>
              <Form.Item label={'出库状态'}>
                {getFieldDecorator('deliveryStatus', {
                  initialValue: selectDetails ? selectDetails.deliveryStatus : '',
                })(<Input disabled={disabled} />)}
              </Form.Item>
            </Col>
          </Row>
          ...
          <Row gutter={_gutter}>
            ...
            <Col {..._col}>
              <Form.Item label={'发货单号'}>
                {getFieldDecorator('outboundNoticeNo', {
                  initialValue: selectDetails ? selectDetails.outboundNoticeNo : '',
                }
                )(<Input disabled={disabled} />
                )}
              </Form.Item>
