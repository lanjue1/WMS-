            ...
            <Col {..._col}>
              <Form.Item label={'报关方式'}>
                {getFieldDecorator('declarationMode', {
                  ...
                  <AdSelect payload={{ code: 'WMS_PO_DECLARATION_MODE' }} disabled={disabled} />
                )}
              </Form.Item>
            </Col>
          </Row>
            ...
            <Col {..._col}>
              <Form.Item label={'贸易条款'}>
                {getFieldDecorator('tradeClause', {
                  ...
                  <AdSelect payload={{ code: 'WMS_PO_TRADE_CLAUSE' }} disabled={disabled} />
                )}
              </Form.Item>
            </Col>
            <Col {..._col}>
              <Form.Item label={'监管类型'}>
                {getFieldDecorator('regulationType', {
                  ...
                  <AdSelect payload={{ code: 'WMS_PO_REGULATION_TYPE' }} disabled={disabled} />
