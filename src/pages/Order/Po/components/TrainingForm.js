            ...
            <Col {..._col}>
              <Form.Item label={'承运商'}>
                {getFieldDecorator('forwarder', {
                  ...
                  <SearchSelect
                    dataUrl={'/wms-contact-unit/selectWmsContactUnitInfo'}
                    selectedData={this.state.forwarder}  // 选中值
                    multiple={false}
                    showValue="name"
                    searchName="name"
            ...
            <Col {..._col}>
              <Form.Item label={'运输状态'}>
                {getFieldDecorator('transportStatus', {
                  ...
                  <AdSelect payload={{ code: allDictList.WMS_PO_TRANSPORT_STATUS }} disabled={disabled} />
                )}
              </Form.Item>
            </Col>
          </Row>
            ...
            <Col {..._col}>
              <Form.Item label={'司机'}>
                {getFieldDecorator('driverName', {
                  // rules: [{ required: true, message: '请输入' }],
                  initialValue: selectDetails ? selectDetails.driverName : '',
                }
            ...
            <Col {..._col}>
              <Form.Item label={'发货人'}>
                {getFieldDecorator('consignorName', {
                  initialValue: selectDetails && selectDetails.consignorName ? selectDetails.consignorName : '',
                })(
                  <Input disabled={disabled} />)}
              </Form.Item>
            </Col>
            ...
            <Col {..._col}>
              <Form.Item label={'发货地址'}>
                {getFieldDecorator('poCpctFrom', {
                  //  rules: [{ required: true, message: '请输入' }],
                  initialValue: selectDetails ? selectDetails.poCpctTo : '',
                }
                )(
            ...
            <Col {..._col}>
              <Form.Item label={'收货人'}>
                {getFieldDecorator('consigneeName', {
                  //  rules: [{ required: true, message: '请输入' }],
                  initialValue: selectDetails ? selectDetails.consigneeName : '',
                }
                )(<Input disabled={disabled} />)}
              </Form.Item>
            </Col>
