...
export async function DictList(params) {
  ...
  return request(`/server/api/mds-dict/selectMdsDictList`, {
    method: 'POST',
    body: params,
  });
}
...
export async function dictAdd(params) {
  return request(
    `/server/api/mds-dict/insertMdsDict`,
    {
      method: 'POST',
      body: params,
    },
...
export async function dictEdit(params) {
  return request(
    `/server/api/mds-dict/updateMdsDict`,
    {
      method: 'POST',
      body: params,
    },
...
export async function dictDetails(params) {
  return request(
    `/server/api/mds-dict/viewMdsDictDetails`,
    {
      method: 'POST',
      body: params,
    },
...
export async function disabledDictInfo(params) {
  return request(
    `/server/api/mds-dict/disableMdsDict`,
    {
      method: 'POST',
      body: params,
    },
...
export async function enableDictInfo(params) {
  return request(
    `/server/api/mds-dict/enableMdsDict`,
    {
      method: 'POST',
      body: params,
    },
...
export async function dictDataList(params) {
  return request(`/server/api/mds-dict-data/selectMdsDictDataList`, {
    method: 'POST',
    body: params,
  });
}
export async function dictDataAdd(params) {
  return request(
    `/server/api/mds-dict-data/insertMdsDictData`,
    {
      method: 'POST',
      body: params,
    },
...
export async function dictDataEdit(params) {
  return request(
    `/server/api/mds-dict-data/updateMdsDictData`,
    {
      method: 'POST',
      body: params,
    },
...
export async function dictDataDetails(params) {
  //mds-dict-data/viewDetails
  return request(`/server/api/mds-dict-data/viewMdsDictDataDetails`, {
    method: 'POST',
    body: params,
  });
}
...
export async function disabledDictDataInfo(params) {
  return request(
    `/server/api/mds-dict-data/disableMdsDictData`,
    {
      method: 'POST',
      body: params,
    },
...
export async function enableDictDataInfo(params) {
  return request(
    `/server/api/mds-dict-data/enableMdsDictData`,
    {
      method: 'POST',
      body: params,
    },
